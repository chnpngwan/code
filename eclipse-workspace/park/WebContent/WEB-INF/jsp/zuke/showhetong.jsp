...
<div><br />
	...
	<p>租赁停车位地址：<span name="zuke">${hetong.address}</span>　</p>　
	<p>依据《中华人民共和国合同法》有关条款，甲乙双方经过充分协商，就乙方租赁甲方停车位事宜达成如下协议：</p>
	<p>一、乙方租赁甲方停车位，以下简称租赁停车位。</p>
	<p>二、起租时间：<span name="fromdate" >${hetong.fromdate}</span>，退租时间：<span name="todate">${hetong.todate}</span>。
	在合同签订之日，乙方需向甲方支付停车位租金￥<span name="price">${hetong.price}</span>。如续租，请提前3天通知甲方，并重新办理租赁手续。<br /></p>　　　　
	<p>三、违约处理：</p>　
	<p>甲方违约：</p>　
	<p>1．如甲方未能及时将押金退还乙方，甲方每天应按押金的2％向乙方支付违约金；</p>
	<p>2．如甲方提供的维修服务项目与协议不相符，乙方有权提前退租，甲方应全额退还剩余的租金。</p>
	<p>乙方违约：</p>　　
	<p>1．如乙方不按时缴纳租金，甲方有权在其押金中扣除，同时收回停车位，所有损失由乙方负责；</p>　
