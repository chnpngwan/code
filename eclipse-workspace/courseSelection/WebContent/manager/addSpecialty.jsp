						...
						<tr>
							...
							<td width="43%" bgcolor="#FFFFFF">
								...
								<html:select property="enterYear">
									<html:option value="2021">2021届</html:option>
									<html:option value="2022">2022届</html:option>
									<html:option value="2023">2023届</html:option>
									<html:option value="2024">2024届</html:option>
									<html:option value="2025">2025届</html:option>
									<html:option value="2026">2026届</html:option>
									<html:option value="2027">2027届</html:option>
									<html:option value="2028">2028届</html:option>
									<html:option value="2029">2029届</html:option>
									<html:option value="2030">2030届</html:option>
								</html:select>
							</td>
