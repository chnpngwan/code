	...
	<body>
		<header>
			...
			<div class="container-fluid" style="width: 0px auto;margin-top: 50px;">
				<div class="navbar-header grid" style="margin-top: 15px;">
					<ul class="grid nav-pills" style="margin-top: 5px;margin-left:180px;">
						<li><img src="http://skk-0817-31.demo.mxyhn.xyz:8020/demo1039/style/images/icon_hot.png" /></li>
						<li>
							<p style="color: black;font-size: 20px;">当前位置:</p>
						</li>
						<li style="padding-top: 5px;">主页>客户案例></li>
					</ul>
				</div>
            ...
            <!-- <div style="width: 1180px;margin: 0px auto;">
            	<div id="button_carShow" align="center" style="margin-top: 50px;float: left;">
            		<ul class="grid" style="width: 900px;">
            		   <li>
            		      提供额外的视觉效果，标识一组按钮中的原始动作
            		      <form action="QueryAllClient">
            		          <button type="submit" class="btn">豪华型</button>
            		      </form>
            		   </li>
            		   <li>
            		         表示一个成功的或积极的动作
            		         <form action="SelectAllCar1">
            		         <button type="submit" class="btn ">舒适型</button>
            		          </form>
            		   </li>
            		   <li>
            		        信息警告消息的上下文按钮
            		        <form action="SelectAllCar3">
            		             <button type="submit" class="btn ">经济型</button>
            		         </form>
            		   </li>
            		   <li>
            		        表示应谨慎采取的动作
            		        <form action="SelectAllCar4">
            		        <button type="submit" class="btn ">越野SUV</button>
            		         </form>
            		   </li>
            		   <li>
            		        表示一个危险的或潜在的负面动作
            		        <form action="SelectAllCar5">
		...
		<div style="width: 1180px;margin: 0px auto;margin-top: 150px;">
				<div class="container" style="position: absolute;">
					<div class="row clearfix grid grid-cell-3">
						...
						<div class="col-md-4 column" id="Button_Img">
							<img id="IMG" alt="140x140" src="${clientList.img }" />
			...
			<div style="width: 1180px;margin: 0px auto;margin-top: 100px;" class="grid">
			       <div align="center" style="position: absolute;margin-top: 400px;">
						...
						<a href="<%=basePath %>/selectSllClient.do?page=1" style="color:blue;">首页</a>&emsp;
						<a href="<%=basePath %>/selectSllClient.do?page=${pageInfo.pageNum-1 }" style="color:blue;">上一页</a>&emsp;
						<c:forEach items="${pageInfo.navigatepageNums }" var="p">
						    <a href="<%=basePath %>/selectSllClient.do?page=${p }"  style="color:blue;">${p }</a>&nbsp;
						</c:forEach>
						<a href="<%=basePath %>/selectSllClient.do?page=${pageInfo.pageNum+1 }" style="color:blue;">下一页</a>&emsp;
						<a href="<%=basePath %>/selectSllClient.do?page=${pageInfo.pages }" style="color:blue;">尾页</a>&emsp;
		         </div>  
			</div>
		</header>
		<!-- 尾部 -->
