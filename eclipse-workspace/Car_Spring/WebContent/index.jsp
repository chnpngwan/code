			...
			<div id="myCarousel" class="carousel slide">
				...
				<div class="carousel-inner" id="img_lunbo">
					<div class="item active">
						<img src="img/home1.jpg" alt="First slide">
					</div>
					<div class="item">
						<img src="img/home2.jpg" alt="Second slide">
					</div>
					<div class="item">
						<img src="img/home3.jpg" alt="Third slide">
					</div>
				</div>
				<!-- 轮播（Carousel）导航 -->
						...
						<div class="container">
							<div class="row clearfix">
								...
								<div class="col-md-6 column">
									<img alt="140x140" src="img/car1.jpg"
									...
									<div class="container">
										...
										<div class="row clearfix grid" id="Sanimg">
											<div class="col-md-4 column">
												<img alt="140x140" src="img/car2.jpg" />
											</div>
											<div class="col-md-4 column">
												<img alt="140x140" src="img/car3.jpg" />
											</div>
											<div class="col-md-4 column">
												<img alt="140x140" src="img/car4.jpg" />
											</div>
										</div>
										<!-- 按钮和价格 -->
					...
					<div class="container">
						<div class="row clearfix grid grid-cell-3">
							...
							<div class="col-md-4 column" id="Button_Img">
								<img alt="140x140" src="img/car5.jpg" />
							...
							<!-- 第二张图片 -->
							<div class="col-md-4 column" id="Button_Img">
								<img alt="140x140" src="img/car6.jpg" />
								<div class="row clearfix" id="Hover_price">
									<div class="col-md-6 column">
										<p>奔驰S级</p>
									</div>
							...
							<!-- 第三张图片 -->
							<div class="col-md-4 column" id="Button_Img">
								<img alt="140x140" src="img/car7.jpg" />
								<div class="row clearfix" id="Hover_price">
									<div class="col-md-6 column" style="padding-top: 10px;">
										<p>奥迪</p>
									</div>
					...
					<div style="width: 1180px;margin: 0px auto;margin-top: 50px;">
						<div align="center">
							<div class="container">
								<div class="row clearfix">
									<div class="col-md-6 column">
										<img alt="140x140" src="img/car8.jpg" />
									</div>
									<div class="col-md-6 column">
										<h2>
											通用企业汽车租赁有限公司
								...
								<table border="1">
									<div class="col-md-8 column">
										...
										<div class="row clearfix" style="height: 300px;">
											<div class="col-md-6 column">
												<img alt="140x140" src="img/car9.jpg"/>
