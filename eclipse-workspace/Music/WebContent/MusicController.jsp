...
<!-- 								<a href="#"> -->
			...
			<div style="width: 95%;text-align: right;position: relative;top: 40px;">
				<a href="MusicBySongID.do?songid=${song.songId }" style="color: white;text-decoration: none;">返回</a>
			</div>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$.ajax({
			...
			url: "getMusicBySongId.do",//请求的Servlet的地址
			dataType: "json",
			data: { "songid": $("#gdID").val() },
			beforeSend: function() {
