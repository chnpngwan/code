...
<!-- 		<link rel="stylesheet" href="https://g.alicdn.com/thx/cube/1.3.2/cube.min.css"> -->
	...
	<body>
		...
		<div style="width: 100%;text-align: center;">
			以下均为搜索关于 <font style="color: lightblue">${text }</font> 的歌曲
		</div>
			...
			<div class="cell-6" style="padding-left: 60px;">
				<table id="musicList" border="0" width="100%" cellpadding="0" cellspacing="0" style="font-size: 18px;">
					 ...
					 <tr  style="font-size: 14px;height: 45px;"  class="qd">
					 	...
					 	<td style="font-size:20px;font-weight: bold;padding-left: 12px;color: #31c27c;">${index1.index+1 }</td>
					 	<td >${music.musicName }
					 	...
					 	<a href="ssmusic.do?text=${text }&musicXH=${index1.index }">
