...
<div style="width: 100%;">
<video style="position: absolute;top: 0;" src="MV/YOUTH.mp4" width="100%"  autoplay="autoplay" loop="loop" muted="muted"></video>
    ...
    <div class="lc-block" id="l-login" data-ng-class="{'toggled':lctrl.login === 1}">
    	<h1 class="lean">register</h1>

		<form action="register.do" name="loginform" method="post">
    	...
    	<div class="input-group m-b-20">
    		...
    		<div class="fg-line">
    			<input type="text" name="username" required="required" class="form-control" placeholder="Username" regex="^\w{3,16}$"/>
    		</div>
    	</div>
        ...
        <div class="input-group m-b-20">
    		...
    		<div class="fg-line">
    			<input type="password" required="required" name="password" class="form-control" placeholder="Password" regex="^\w+"/>
    		</div>
    	</div>
    	...
    	<div class="input-group m-b-20">
    		...
    		<div class="fg-line">
    			<input type="password" required="required" name="OKPassword" class="form-control" placeholder="OKPassword" regex="^\w+"/>
    		</div>
    	</div>
    	<div>已有账号去<a href="login.jsp">登录</a></div>
    	</form>
	...
	$(function () {
		$(document).on("click","#loginbtn",function(){
			...
			var OKpassword=$("input[name='OKPassword']").val().trim()
			if(username==''){
				alert("请输入用户名！")
				return
			}
