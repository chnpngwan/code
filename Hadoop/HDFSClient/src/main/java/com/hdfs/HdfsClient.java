...
public class HdfsClient {
    ...
    public void init() throws URISyntaxException, IOException, InterruptedException {
        // 连接的集群nn地址
        URI uri = new URI("hdfs://172.20.38.220:8020");
        // 创建一个配置文件
    ...
    public void testPut() throws IOException {
        ...
        fs.copyFromLocalFile(false, true, new Path("D:\\sunwukong.txt"), new Path("hdfs://172.20.38.220/xiyou/huaguoshan"));
    }
    ...
    public void testGet() throws IOException {
        ...
        fs.copyToLocalFile(false, new Path("hdfs://172.20.38.220/a.txt"), new Path("D:\\"), false);
    }
