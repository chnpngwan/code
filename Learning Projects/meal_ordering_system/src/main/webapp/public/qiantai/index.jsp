...
<head>
    ...
    <link
            href="${pageContext.request.contextPath}/public/qiantai/css/common.css"
            rel="stylesheet" type="text/css" />
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/public/qiantai/js/base.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/public/qiantai/js/common.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/public/qiantai/js/form.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/public/qiantai/js/blockui.js"></script>
            ...
            <table width="100%" border="0" cellspacing="0"
                ...
                <tr>
                    <td width="59%" align="left" valign="top">
                        <div id='pdv_3606' class='pdv_class'
                             title=''
...
<div style="float:right;margin-right:10px;display:none"> <a href="-1" style="line-height:25px;color:">更多</a> </div>
                                    ...
                                    <div style="padding: 0px">
                                        <link
                                                href="${pageContext.request.contextPath}/public/qiantai/css/dingcanall.css"
                                                rel="stylesheet"
                                                type="text/css" />
                                        <script
                                                src="${pageContext.request.contextPath}/public/qiantai/js/dingcanall.js"
                                                        ...
                                                        <% int
                                                            ...
                                                            List<Menus>
                                                                    ...
                                                                    (List
                                                                            ...
                                                                            request.getAttribute("menusList");
                                                                ...
                                                                <div>
                                                                    <table>
                                                                        <tr>
                                                                            <td rowspan="5"
                                                                                class="bookPic">
                                                                                <img src="${pageContext.request.contextPath}/public/<%=menus.getImgpath()%>"
                                    ...
                                    <div
                                            id="dingcanall_bottom_left">
                                        &nbsp;</div>
                                    <div
                                            id="dingcanall_bottom_right">
                                        &nbsp;</div>
                                    <input type="hidden"
                                           name="picw" id="picw"
                                           value="150" /> <input
                                            ...
                                            <div class="pdv_border"
                                                ...
                                                <div
                                                    ...
                                                    <div style="margin: 0px 3px; padding: 10px;"
                                                         align="left">
                                                        <link
                                                                href="${pageContext.request.contextPath}/public/qiantai/css/newslist_time2.css"
                                                                rel="stylesheet"
                                                                type="text/css" />
                                                        ...
                                                        <ul
                                                            ...
                                                            <c:forEach
                                                                ...
                                                                <li
                                                                    ...
                                                                    <a href="<c:url value="
                                                                                                                                /notice/queryByIdtoQiantai?id=${notice.id}" />"
                                            ...
                                            <div class="pdv_border"
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        ...
                                                        <a href="-1"
                                                           style="line-height: 25px;">更多</a>
                                                    </div>
                                                </div>
                                                <div
                                                        style="padding: 0px">
                                                    <link
                                                            href="${pageContext.request.contextPath}/public/qiantai/css/dingcanche.css"
                                                            rel="stylesheet"
                                                            type="text/css" />
                                                    <script
                                                            src="${pageContext.request.contextPath}/public/qiantai/js/dingcanall.js"
                                                            type="text/javascript"></script>
                                                    <script
                                                            src="${pageContext.request.contextPath}/public/qiantai/js/dingcansubmit.js"
                                                            type="text/javascript"></script>
                                                    <div
                                                            id="dingcanche">
                                                        <div
                                                            ...
                                                            <div
                                                                    id="dingcanche_top">
                                                                <div
                                                                        id="dingcanche_top_left">
                                                                    我的餐车
                                                                </div>
                                                                <div
                                                                        id="dingcanche_top_right">
                                                                    &nbsp;
                                                                </div>
                                                            </div>
                                                                ...
                                                                <% float
                                                                    ...
                                                                    List<ShoppingCart>
                                                                            ...
                                                                            (List
                                                                                    ...
                                                                                    session.getAttribute("shoppingcar");
                                                                    if
                                                                    (shoppingcar
                                                                            !=
                                                                            null)
                                                            ...
                                                            <div
                                                                    style="height: 24px; margin: 5px 3px 1px 3px;">
                                                                <div
                                                            ...
                                                            <div
                                                                    style="height: 30px; margin: 5px 3px 1px 3px;">
                                                                <table
                                                                        width="100%"
                                                                        border="0"
                                                                        cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td align="center"
                                                                            width="40%">
                                                                            <a href="<c:url value="
                                                                                                                                        /orders/order_addshoppingcartoOrder" />"><img
                                                ...
                                                <div
                                                        id="dingcanche_bottom_left">
                                                    &nbsp;</div>
                                                <div
                                                        id="dingcanche_bottom_right">
                                                    &nbsp;</div>
                                                <input
                                                        type="hidden"
                                                        name="modnums_b"
                                        ...
                                        <div id='spdv_3613'
                                            ...
                                            <div class="pdv_border"
                                                ...
                                                <div
                                                        style="padding: 0px">
                                                    <link
                                                            href="${pageContext.request.contextPath}/public/qiantai/css/dingcanweekmenu.css"
                                                            rel="stylesheet"
                                                            type="text/css" />
                                                    <div
                                                            id="dingcanweekmenu">
                                                        <div
                                                                id="dingcanweekmenu2">
                                                            <div
                                                                    id="dingcanweekmenu_top">
                                                                <div
                                                                        id="dingcanweekmenu_top_left">
                                                                    销售排行榜
                                                                </div>
                                                                <div
                                                                        id="dingcanweekmenu_top_right">
                                                                    &nbsp;
                                                                </div>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div class="dingcanweekmenuinfo"
                                                                    ...
                                                                    <li
                                                                        ...
                                                                        <a href="show.jsp?id=<%=menus1.getId()%>"
                                                                           class="newslist_time2">
                                                                            <%=menus1.getName()%>
                                                                        </a>
                                                                    </li>
