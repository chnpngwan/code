...
<% String path=request.getContextPath(); String basePath=request.getScheme() + "://" +
		request.getServerName() + ":" + request.getServerPort() + path + "/" ; System.out.println(basePath);
%>
<html>
...
<head>
	...
	<link href="${pageContext.request.contextPath}/public/qiantai/css/common.css" rel="stylesheet"
		  type="text/css" />
	<link href="${pageContext.request.contextPath}/public/qiantai/css/skin.css" rel="stylesheet"
		  type="text/css" />
	<script src="${pageContext.request.contextPath}/public/qiantai/js/date.js"
								...
								<table id="table1" class="line_table"
									...
									<tr>
										<td class="line_table" align="center" colspan="3">
											<a
													href="/orders/ordergetall">我的所有订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a
													href="/orders/ordergetallbydelivery?delivery=0">未已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
											<a
													href="/orders/ordergetallbydelivery?delivery=1">已派送订单</a>&nbsp;&nbsp;&nbsp;&nbsp;
										</td>
									</tr>
								</table>
							</form>
							...
							<table id="table2" class="line_table"
								...
								<tr>
									...
									<% List<Orders> list = (List<Orders>)
                                                                    session.getAttribute("ordersearch");
                                                                    if (list != null) {
                                                                    for (int i = 0; i < list.size(); i++) { Orders
                                                                        order=list.get(i); Menus menus=order.getMenus();
                                                                        Users users=order.getUsers(); String str="" ; if
                                                                        (order.getDelivery()==1) { str="是" ; } else {
                                                                        str="否" ; } %>
								<td class="line_table" align="center"><span
										class="left_txt">
                                                                                <%=menus.getName() %>
