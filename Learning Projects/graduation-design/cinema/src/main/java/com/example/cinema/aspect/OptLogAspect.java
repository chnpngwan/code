...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.example.cinema.annotation.OptLog)")
    ...
    public void saveOptLog(JoinPoint joinPoint, Object keys) {
        ...
        // 请求用户ID
        operationLog.setUserId(LoginUtil.getLoginUser().getId());
        // 请求用户
        operationLog.setNickname(LoginUtil.getLoginUser().getNickname());
        // 请求IP
