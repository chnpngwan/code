...
import com.example.entity.DormManager;
import com.example.entity.Student;
import com.example.service.AdminService;
import com.example.service.DormManagerService;
...
@Api(value = "文件API接口", tags = "文件API接口")
public class FileController {

    private static final String ip = "http://localhost";
    static String rootFilePath = System.getProperty("user.dir") + "/upload/files/";
