  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="老师性别" prop="teacherSex">
        <el-select v-model="queryParams.teacherSex" placeholder="请选择老师性别" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="老师性别" align="center" prop="teacherSex">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sys_user_sex" :value="scope.row.teacherSex"/>
        </template>
      </el-table-column>
      <el-table-column label="老师头像" align="center" prop="teacherImg" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.teacherImg" :width="50" :height="50"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="老师头像" prop="teacherImg">
          <image-upload v-model="form.teacherImg"/>
        </el-form-item>
        <el-form-item label="老师描述">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除老师列表编号为"' + teacherIds + '"的数据项？').then(function() {
