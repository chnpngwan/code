<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="父产品编号" prop="parentId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="父产品编号" prop="parentId">
          <treeselect v-model="form.parentId" :options="productOptions" :normalizer="normalizer" placeholder="请选择父产品编号" />
        </el-form-item>
        <el-form-item label="产品名称" prop="productName">
...
export default {
  ...
  methods: {
    ...
    /** 删除按钮操作 */
    handleDelete(row) {
      this.$modal.confirm('是否确认删除产品列表编号为"' + row.productId + '"的数据项？').then(function() {
