...
public class JiaoxuefankuiController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiaoxuefankuiEntity jiaoxuefankui, 
		...
		if(tableName.equals("jiaoshi")) {
			jiaoxuefankui.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("xuesheng")) {
			jiaoxuefankui.setXuehao((String)request.getSession().getAttribute("username"));
		}
