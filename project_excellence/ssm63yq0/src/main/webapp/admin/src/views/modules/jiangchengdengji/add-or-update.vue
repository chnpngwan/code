<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="奖惩日期" prop="jiangchengriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiangchengriqi" 
                type="date"
                :readonly="ro.jiangchengriqi"
                placeholder="奖惩日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiangchengriqi" label="奖惩日期" prop="jiangchengriqi">
              <el-input v-model="ruleForm.jiangchengriqi" 
                placeholder="奖惩日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="奖惩原因" prop="jiangchengyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="奖惩原因"
                  v-model="ruleForm.jiangchengyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiangchengyuanyin" label="奖惩原因" prop="jiangchengyuanyin">
                    <span>{{ruleForm.jiangchengyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="奖惩内容" prop="jiangchengneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="奖惩内容"
                  v-model="ruleForm.jiangchengneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiangchengneirong" label="奖惩内容" prop="jiangchengneirong">
                    <span>{{ruleForm.jiangchengneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xingming : false,
	leixing : false,
	jiangchengyuanyin : false,
	jiangchengneirong : false,
	jiangchengriqi : false,
      },
      ruleForm: {
        jiaoshizhanghao: '',
        jiaoshixingming: '',
  ...
  created() {
	this.ruleForm.jiangchengriqi = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
          ...
          if(o=='jiangchengyuanyin'){
            this.ruleForm.jiangchengyuanyin = obj[o];
	    this.ro.jiangchengyuanyin = true;
            continue;
          }
          if(o=='jiangchengneirong'){
            this.ruleForm.jiangchengneirong = obj[o];
	    this.ro.jiangchengneirong = true;
            continue;
          }
          if(o=='jiangchengriqi'){
            this.ruleForm.jiangchengriqi = obj[o];
	    this.ro.jiangchengriqi = true;
            continue;
          }
        }
      }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiangchengdengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiangchengdengjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
