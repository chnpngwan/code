<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="报告单号" prop="baogaodanhao">
            <el-input v-model="ruleForm.baogaodanhao" 
                placeholder="报告单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baogaodanhao" label="报告单号" prop="baogaodanhao">
              <el-input v-model="ruleForm.baogaodanhao" 
                placeholder="报告单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="血糖" prop="xuetang">
          <el-input v-model="ruleForm.xuetang" 
              placeholder="血糖" clearable  :readonly="ro.xuetang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="血糖" prop="xuetang">
              <el-input v-model="ruleForm.xuetang" 
                placeholder="血糖" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tijianbaogao" label="体检报告" prop="tijianbaogao">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.tijianbaogao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
