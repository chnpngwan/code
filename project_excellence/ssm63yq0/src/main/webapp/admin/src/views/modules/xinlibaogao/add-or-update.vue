<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.xinlibaogao" label="心理报告" prop="xinlibaogao">
          <file-upload
          tip="点击上传心理报告"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.xinlibaogao?ruleForm.xinlibaogao:''"
          @change="xinlibaogaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.xinlibaogao" label="心理报告" prop="xinlibaogao">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.xinlibaogao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="健康等级" prop="jiankangdengji">
        ...
        <div v-else>
          <el-form-item class="input" label="健康等级" prop="jiankangdengji">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='xinlibaogao'){
            this.ruleForm.xinlibaogao = obj[o];
	    this.ro.xinlibaogao = true;
            continue;
          }
          if(o=='jiankangdengji'){
	...
	if(this.ruleForm.xinlibaogao!=null) {
		this.ruleForm.xinlibaogao = this.ruleForm.xinlibaogao.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xinlibaogao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xinlibaogaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    xinlibaogaoUploadChange(fileUrls) {
	this.ruleForm.xinlibaogao = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
