  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
	    ...
	    <download-excel v-if="isAuth('tijianbaogao','导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "体检报告.xls">
		      <!-- 导出excel -->
            	<el-button
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="血糖">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="tijianbaogao"
                   :header-align="contents.tableAlign"
                    label="体检报告">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download($base.url+scope.row.tijianbaogao)">下载</el-button>
                    </template>
                  </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign" 
                    prop="dengjishijian"
...
//导出excel
      json_fields: {
      "报告单号": "baogaodanhao",    //常规字段
      "体检项目": "tijianxiangmu",    //常规字段
      "学号": "xuehao",    //常规字段
      "姓名": "xingming",    //常规字段
      "身高": "shengao",    //常规字段
      "体重": "tizhong",    //常规字段
      "血糖": "xuetang",    //常规字段
      "体检报告": "tijianbaogao",    //常规字段
      "建议": "jianyi",    //常规字段
  ...
  methods: {
    ...
    async printJson() {
      ...
      for (let i=0; i < this.list.length; i++) {
          data.push({
          baogaodanhao: this.list[i].baogaodanhao,
          tijianxiangmu: this.list[i].tijianxiangmu,
          xuehao: this.list[i].xuehao,
          xingming: this.list[i].xingming,
          shengao: this.list[i].shengao,
          tizhong: this.list[i].tizhong,
          xuetang: this.list[i].xuetang,
