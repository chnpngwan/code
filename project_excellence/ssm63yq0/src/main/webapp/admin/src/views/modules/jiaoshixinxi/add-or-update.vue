<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教室编号" prop="jiaoshibianhao">
          <el-input v-model="ruleForm.jiaoshibianhao" 
              placeholder="教室编号" clearable  :readonly="ro.jiaoshibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教室编号" prop="jiaoshibianhao">
              <el-input v-model="ruleForm.jiaoshibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教室名称" prop="jiaoshimingcheng">
          <el-input v-model="ruleForm.jiaoshimingcheng" 
              placeholder="教室名称" clearable  :readonly="ro.jiaoshimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教室名称" prop="jiaoshimingcheng">
              <el-input v-model="ruleForm.jiaoshimingcheng" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jiaoshitupian" label="教室图片" prop="jiaoshitupian">
          <file-upload
          tip="点击上传教室图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.jiaoshitupian?ruleForm.jiaoshitupian:''"
          @change="jiaoshitupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.jiaoshitupian" label="教室图片" prop="jiaoshitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jiaoshitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="教室位置" prop="jiaoshiweizhi">
          <el-input v-model="ruleForm.jiaoshiweizhi" 
              placeholder="教室位置" clearable  :readonly="ro.jiaoshiweizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="教室位置" prop="jiaoshiweizhi">
              <el-input v-model="ruleForm.jiaoshiweizhi" 
                placeholder="教室位置" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="教室详情" prop="jiaoshixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiaoshixiangqing" label="教室详情" prop="jiaoshixiangqing">
                    <span v-html="ruleForm.jiaoshixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshimingcheng = true;
          ...
          if(o=='jiaoshitupian'){
            this.ruleForm.jiaoshitupian = obj[o];
	    this.ro.jiaoshitupian = true;
            continue;
          }
          if(o=='jiaoshiweizhi'){
	...
	this.ruleForm.jiaoshixiangqing = this.ruleForm.jiaoshixiangqing.replace(reg,'../../../ssm63yq0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.jiaoshitupian!=null) {
		this.ruleForm.jiaoshitupian = this.ruleForm.jiaoshitupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
	...
	this.ruleForm.jiaoshitupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
