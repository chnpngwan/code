    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="选择原因" prop="xuanzeyuanyin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xuanzeyuanyin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuanzeyuanyin" label="选择原因" prop="xuanzeyuanyin">
                    <span v-html="ruleForm.xuanzeyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shhf : false,
      ...
      rules: {
          ...
          xuanzeyuanyin: [
                { required: true, message: '选择原因不能为空', trigger: 'blur' },
          ],
          jiaoshizhanghao: [
          ],
          jiaoshixingming: [
  ...
  methods: {
	...
	this.ruleForm.xuanzeyuanyin = this.ruleForm.xuanzeyuanyin.replace(reg,'../../../ssm63yq0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
