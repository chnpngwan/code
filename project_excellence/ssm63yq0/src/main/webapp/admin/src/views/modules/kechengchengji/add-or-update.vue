<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程分数" prop="kechengfenshu">
          <el-input v-model="ruleForm.kechengfenshu" 
              placeholder="课程分数" clearable  :readonly="ro.kechengfenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程分数" prop="kechengfenshu">
              <el-input v-model="ruleForm.kechengfenshu" 
                placeholder="课程分数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.pingfenriqi" label="评分日期" prop="pingfenriqi">
              <el-input v-model="ruleForm.pingfenriqi" 
                placeholder="评分日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
