<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="反馈编号" prop="fankuibianhao">
            <el-input v-model="ruleForm.fankuibianhao" 
                placeholder="反馈编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fankuibianhao" label="反馈编号" prop="fankuibianhao">
              <el-input v-model="ruleForm.fankuibianhao" 
                placeholder="反馈编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="评价课程" prop="pingjiakecheng">
          <el-select :disabled="ro.pingjiakecheng" v-model="ruleForm.pingjiakecheng" placeholder="请选择评价课程">
            <el-option
                v-for="(item,index) in pingjiakechengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="评价课程" prop="pingjiakecheng">
	      <el-input v-model="ruleForm.pingjiakecheng"
                placeholder="评价课程" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="教学质量" prop="jiaoxuezhiliang">
          <el-select :disabled="ro.jiaoxuezhiliang" v-model="ruleForm.jiaoxuezhiliang" placeholder="请选择教学质量">
            <el-option
                v-for="(item,index) in jiaoxuezhiliangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="教学质量" prop="jiaoxuezhiliang">
	      <el-input v-model="ruleForm.jiaoxuezhiliang"
                placeholder="教学质量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="满意程度" prop="manyichengdu">
        ...
        <div v-else>
          <el-form-item class="input" label="满意程度" prop="manyichengdu">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="反馈内容" prop="fankuineirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.fankuineirong" label="反馈内容" prop="fankuineirong">
                    <span>{{ruleForm.fankuineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	pingjiakecheng : false,
	jiaoxuezhiliang : false,
	manyichengdu : false,
	...
	xingming : false,
      ...
      ruleForm: {
        ...
        xingming: '',
          ...
          pingjiakechengOptions: [],
          jiaoxuezhiliangOptions: [],
          manyichengduOptions: [],
      rules: {
          fankuibianhao: [
          ],
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='fankuibianhao'){
            this.ruleForm.fankuibianhao = obj[o];
	    this.ro.fankuibianhao = true;
            continue;
          }
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='pingjiakecheng'){
            this.ruleForm.pingjiakecheng = obj[o];
	    this.ro.pingjiakecheng = true;
            continue;
          }
          if(o=='jiaoxuezhiliang'){
            this.ruleForm.jiaoxuezhiliang = obj[o];
	    this.ro.jiaoxuezhiliang = true;
            continue;
          }
          if(o=='manyichengdu'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.pingjiakechengOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
            this.jiaoxuezhiliangOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
            this.manyichengduOptions = "满意,一般,不满意".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `jiaoxuefankui/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `jiaoxuefankui/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiaoxuefankuiCrossAddOrUpdateFlag = false;
						 this.parent.search();
