...
const routes = [
	...
	//汽车信息列表路由
	{
		path: '/car_information/list',
		name: '/car_information_list',
		component: () => import('../views/car_information/list.vue')
	},
	//汽车信息详情路由
	{
		path: '/car_information/details',
		name: '/car_information_details',
		component: () => import('../views/car_information/details.vue')
	},
	//租车订单添加路由
	{
		path: '/car_rental_order/edit',
		name: '/car_rental_order_edit',
		component: () => import('../views/car_rental_order/edit.vue')
	},
