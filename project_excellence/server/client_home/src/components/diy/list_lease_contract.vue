		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','contract_name')">合同名称
					</th>
					<th class="diy_title" v-if="$check_field('get','contract_content')">合同内容
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','contract_name')">
						<span>
							{{ o["contract_name"] }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','contract_content')">
						<span>
							{{ o["contract_content"] }}
						</span>
					</td>
