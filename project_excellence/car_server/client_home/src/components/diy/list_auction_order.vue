<template>
	<div class="diy_home diy_list diy_auction_order" id="diy_auction_order_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/auction_order/details?auction_order_id=' + o['auction_order_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/auction_order/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/auction_order/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','mark_up_amount')">加价金额
					</th>
					<th class="diy_title" v-if="$check_field('get','buyer_number')">买家编号
					</th>
					<th class="diy_title" v-if="$check_field('get','buyer_name')">买家姓名
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','current_price')">
						<span>
							{{ o["current_price"] }}
						</span>
					</td>
					<td class="diy_field diy_number" v-if="$check_field('get','mark_up_amount')">
						<span>
							{{ o["mark_up_amount"] }}
						</span>
					</td>
					<td class="diy_field diy_uid" v-if="$check_field('get','buyer_number')">
						<span>
							{{ get_user_name(o['buyer_number']) }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','buyer_name')">
						<span>
							{{ o["buyer_name"] }}
						</span>
					</td>
