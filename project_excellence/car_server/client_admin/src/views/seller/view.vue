		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','seller_number') || $check_field('add','seller_number') || $check_field('set','seller_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="卖家编号" prop="seller_number">
					<el-input id="seller_number" v-model="form_sub['seller_number']" placeholder="请输入卖家编号"
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','seller_number')) || (!form_sub['seller_id'] && $check_field('add','seller_number'))"></el-input>
					<div v-else-if="$check_field('get','seller_number')">{{form_sub['seller_number']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','seller_name') || $check_field('add','seller_name') || $check_field('set','seller_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="卖家姓名" prop="seller_name">
					<el-input id="seller_name" v-model="form_sub['seller_name']" placeholder="请输入卖家姓名"
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','seller_name')) || (!form_sub['seller_id'] && $check_field('add','seller_name'))"></el-input>
					<div v-else-if="$check_field('get','seller_name')">{{form_sub['seller_name']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','home_address') || $check_field('add','home_address') || $check_field('set','home_address')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="家庭地址" prop="home_address">
					<el-input id="home_address" v-model="form_sub['home_address']" placeholder="请输入家庭地址"
							  v-if="user_group === '管理员' || (form_sub['seller_id'] && $check_field('set','home_address')) || (!form_sub['seller_id'] && $check_field('add','home_address'))"></el-input>
