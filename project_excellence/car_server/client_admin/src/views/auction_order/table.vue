<template>
	<el-main class="bg table_wrap">
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="拍卖单号">
						<el-input v-model="query.auction_number"></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
				...
				<el-col :xs="24" :sm="24" :lg="8" class="el_form_search_wrap">
					<el-form-item label="买家姓名">
						<el-input v-model="query.buyer_name"></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_wrap_1">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/auction_order/table','add') || $check_action('/auction_order/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            <el-button v-if="user_group == '管理员' || $check_action('/auction_order/table','del') || $check_action('/auction_order/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="mark_up_amount" label="加价金额"
				v-if="user_group == '管理员' || $check_field('get','mark_up_amount')" min-width="200">
			</el-table-column>
			<el-table-column prop="buyer_number" label="买家编号"
				v-if="user_group == '管理员' || $check_field('get','buyer_number')" min-width="200">
				<template slot-scope="scope">
					{{ get_user_buyer_number(scope.row['buyer_number']) }}
				</template>
			</el-table-column>
			<el-table-column prop="buyer_name" label="买家姓名"
				v-if="user_group == '管理员' || $check_field('get','buyer_name')" min-width="200">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/auction_order/table','set') || $check_action('/auction_order/view','set') || $check_action('/auction_order/view','get') || $check_action('//table','add') || $check_action('//view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/auction_order/table','set') || $check_action('/auction_order/view','set') || $check_action('/auction_order/view','get')"
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/auction_order/get_list?like=0",
				url_del: "~/api/auction_order/del?",
