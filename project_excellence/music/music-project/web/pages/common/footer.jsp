...
<footer class="footer">
    <div class="container-fluid">类型/流派
        <div class="row">
            <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-4 order-xl-1">
                <div class="footer__logo">
                    <img src="static/img/logo.svg" alt="">
                </div>
                <p class="footer__tagline">唱片公司和互联网电台，<br>在线音乐HTML模板。</p>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0">
                <h6 class="footer__title">沃尔纳酒店</h6>
                <div class="footer__nav">
                    <a href="pages/pag/about.jsp">About</a>
                    <a href="pages/pag/profile.jsp">My profile</a>
                    <a href="pages/pag/pricing.jsp">Pricing plans</a>
                    <a href="pages/pag/contacts.jsp">Contacts</a>
                </div>
            </div>
            ...
            <div class="col-12 col-md-8 col-lg-6 col-xl-4 order-3 order-lg-2 order-md-3 order-xl-3">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="footer__nav">
                            <a href="pages/artists.jsp">Artists</a>
                            <a href="pages/releases.jsp">Releases</a>
                            <a href="pages/events.jsp">Events</a>
                            <a href="pages/podcasts.jsp">Podcasts</a>
                        </div>
                    </div>
                    ...
                    <div class="col-6">
                        <div class="footer__nav">
                            ...
                            <a href="pages/store.jsp">Store</a>
                            <a href="#">Music</a>
                            <a href="#">Video</a>
                        </div>
                    </div>
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-2 order-lg-3 order-md-4 order-xl-4">
                ...
                <div class="footer__nav">
                    <a href="privacy.jsp">Account & Billing</a>
                    <a href="privacy.jsp">Plans & Pricing</a>
                    <a href="privacy.jsp">Supported devices</a>
                    <a href="privacy.jsp">Accessibility</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="footer__content">
                    <div class="footer__social">
                        ...
                        <a href="#" target="_blank">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                ...
                                <path d="M0 15C0 6.71573 6.71573 0 15 0C23.2843 0 30 6.71573 30 15C30 23.2843 23.2843 30 15 30C6.71573 30 0 23.2843 0 15Z"
                                      fill="#010101"/>
                                <path d="M13.2143 13.1245V12.4195C12.9696 12.3808 12.7224 12.3595 12.4747 12.356C10.0763 12.3509 7.95291 13.9051 7.23271 16.1928C6.51252 18.4805 7.36263 20.9708 9.33138 22.3405C7.85664 20.7622 7.44716 18.4646 8.28583 16.474C9.1245 14.4834 11.0547 13.1716 13.2143 13.1245Z"
                                      fill="#25F4EE"/>
                                <path d="M13.3472 21.1097C14.6881 21.1079 15.7904 20.0515 15.8491 18.7118V6.75693H18.0332C17.9886 6.50713 17.9673 6.25373 17.9696 6H14.9824V17.9433C14.9327 19.2898 13.8279 20.3564 12.4804 20.3586C12.0778 20.3552 11.6817 20.2561 11.3248 20.0697C11.794 20.7197 12.5456 21.1062 13.3472 21.1097Z"
                                      fill="#25F4EE"/>
                                <path d="M22.1125 10.8133V10.1489C21.3087 10.1491 20.5227 9.91193 19.8533 9.46704C20.4401 10.1493 21.2332 10.6219 22.1125 10.8133Z"
                                      fill="#25F4EE"/>
                                <path d="M19.8534 9.46693C19.1939 8.71597 18.8304 7.75063 18.8306 6.75122H18.0333C18.2414 7.86795 18.8996 8.84996 19.8534 9.46693Z"
                                      fill="#FE2C55"/>
                    ...
                    <small class="footer__copyright">© Volna, 2021. Created by <a
                            href="https://themeforest.net/user/dmitryvolkov/portfolio" target="_blank">Dmitry Volkov</a>.</small>
                </div>
            </div>
        </div>
    </div>
