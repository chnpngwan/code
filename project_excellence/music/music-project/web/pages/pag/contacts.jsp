    ...
    <div class="container-fluid">
        <div class="row row--grid">
            ...
            <div class="col-12">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb__item breadcrumb__item--active">留言</li>
                </ul>
            </div>
            <!-- end breadcrumb -->
            <!-- title -->
        ...
        <div class="row row--grid">
            <div class="col-12 col-lg-7 col-xl-8">
                <form class="sign__form sign__form--contacts">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="sign__group">
                                <input type="text" name="name" class="sign__input" placeholder="姓名">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="sign__group">
                                <input type="text" name="email" class="sign__input" placeholder="电子邮件">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="sign__group">
                                <input type="text" name="subject" class="sign__input" placeholder="主题">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="sign__group">
                                <textarea name="comment" class="sign__textarea" placeholder="输入您的留言"></textarea>
                            </div>
                        </div>
                        <div class="col-12 col-xl-3">
                            <button type="button" class="sign__btn">发送</button>
                        </div>
                        <script>
                            $(function () {
                                $("button.sign__btn").click(function () {
                                    $.get("", $("form.sign__form--contacts").serialize(), function (msg) {
                                        if (msg == "true") {
                                            layer.msg("good", {
                                                icon: 1,
                                                time: 2000
            ...
            <div class="col-12 col-md-6 col-lg-5 col-xl-4">
                <div class="main__title main__title--sidebar">
                    <h2>信息</h2>
                    <p>一个很长的事实是，读者在查看页面布局时会被页面的可读内容分散注意力</p>
                </div>
                <ul class="contacts__list">
                    <li><a href="tel:88002345678">8 800 234-56-78</a></li>
                    <li><a href="mailto:support@volna.template">support@volna.模板</a></li>
                    <li>
                        <a href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom"
                           class="open-map">221B 贝克街， 马里波恩， 伦敦</a></li>
                </ul>
