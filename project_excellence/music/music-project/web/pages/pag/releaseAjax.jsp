                    ...
                    <div class="release__list">
                        <ul class="main__list main__list--playlist main__list--dashbox">
                            <li class="single-item" style="display:none;">
                                <a data-playlist data-title="1. Got What I Got"
                                ...
                                <div class="single-item__title">
                                    <h4><a href="javascript:void (0)">1. Got What I Got</a></h4>
                                    <span><a href="pages/pag/artist.jsp">${requestScope.album.authorname}</a></span>
                                </div>
                    ...
                    <div class="comments">
                        ...
                        <ul class="comments__list">
                            <li class="comments__item">
                                ...
                                <p class="comments__text">Lorem
                                    Ipsum的段落有许多变体，但大多数都遭受了某种形式的改变，通过注入幽默或看起来甚至不可信的随机单词。如果你打算使用Lorem
                            ...
                            <li class="comments__item comments__item--answer">
                                ...
                                <p class="comments__text">Lorem Ipsum只是印刷和排版行业的虚拟文本。自 1500 年代以来，Lorem
                                    Ipsum
                                    一直是行业标准的虚拟文本，当时一位不知名的打印机拿起一个类型的厨房并将其打乱以制作类型标本书。</p>
                                <div class="comments__actions">
                                    <div class="comments__rate">
                                        <button type="button">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <div class="col-6 col-sm-4 col-lg-6">
                        <div class="album album--sidebar">
                            <div class="album__cover">
                                <img src="static/img/covers/cover8.jpg" alt="">
                                <a href="pages/pag/release.jsp">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        <path d="M18.54,9,8.88,3.46a3.42,3.42,0,0,0-5.13,3V17.58A3.42,3.42,0,0,0,7.17,21a3.43,3.43,0,0,0,1.71-.46L18.54,15a3.42,3.42,0,0,0,0-5.92Zm-1,4.19L7.88,18.81a1.44,1.44,0,0,1-1.42,0,1.42,1.42,0,0,1-.71-1.23V6.42a1.42,1.42,0,0,1,.71-1.23A1.51,1.51,0,0,1,7.17,5a1.54,1.54,0,0,1,.71.19l9.66,5.58a1.42,1.42,0,0,1,0,2.46Z"/>
                                    </svg>
                                </a>
                            ...
                            <div class="album__title">
                                <h3><a href="pages/pag/release.jsp">太空旋律</a></h3>
                                <span><a href="pages/pag/artist.jsp">尖</a> & <a
                                        href="pages/pag/artist.jsp">艾伦·沃克</a> & <a
                                        href="pages/pag/artist.jsp">莱昂尼</a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    function mymusic() {
        $.get("AlbumServlet", "action=showMusic&id=" +${requestScope.album.id}, function (msg) {
            for (let i = 0; i < msg.length; i++) {
                let newdiv = $("li.single-item:first").clone(true);//clone(true)事件一起复制
                newdiv.css("display", "");
                newdiv.find("a.single-item__cover").attr("data-title", msg[i].song_name);
                newdiv.find("a.single-item__cover").attr("href", msg[i].srcpath);
                newdiv.find("a.single-item__cover img").attr("src", msg[i].facepath);
                newdiv.find("div.album__cover img").attr("src", msg[i].album_faceimg);
                newdiv.find("div.single-item__title").find("a:first").html((i + 1) + "." + msg[i].song_name);
                newdiv.find("span.single-item__time").html(timerest(msg[i].duration));
                $("ul.main__list:last").before(newdiv);
            }
        }, "json")
    }

    function timerest(duration) {
    ...
    $(function () {
        $("span.single-item__time").click(function () {
            layer.msg("添加成功", {
                icon: 1,
                time: 2000
            })
        })
        $("span.single-item__export").click(function () {
            layer.msg("下载成功", {
                icon: 1,
                time: 2000
            })
        })
        $("div.single-item__title span a").click(function () {
            window.location.href = "AlbumServlet?action=toArtist&id=" + ${requestScope.album.id};
        })
        mymusic();
    });
</script>
