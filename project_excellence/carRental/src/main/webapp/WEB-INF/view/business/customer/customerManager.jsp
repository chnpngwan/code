...
<div style="display: none;padding: 20px" id="saveOrUpdateDiv">
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <%--@declare id="idcardno"--%><label class="layui-form-label" for="idCardNo">身份证号:</label>
                <div class="layui-input-inline">
                    <input type="text" name="identity" lay-verify="required" placeholder="请输入客户姓名" autocomplete="off"
                           class="layui-input" id="idCardNo">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                <%--@declare id="mobileno"--%><label class="layui-form-label" for="mobileNo">客户电话:</label>
                <div class="layui-input-inline">
                    <input type="text" name="phone" lay-verify="required|phone" placeholder="请输入客户电话" autocomplete="off"
                           class="layui-input" id="mobileNo">
                </div>
            </div>
            <div class="layui-inline">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block" style="text-align: center;padding-right: 120px">
                <button type="button"
                        ...
                        lay-filter="doSubmit" lay-submit="" onclick="check()">提交
                </button>
                <button type="reset"
                        class="layui-btn layui-btn-warm layui-btn-md layui-icon layui-icon-refresh layui-btn-radius" onclick="check()">重置
                </button>
            </div>
        </div>
    </form>
...
<script type="text/javascript">
    ...
    function checkIdCardNo() {
        ...
        //    alert(idCardNo + "是有效的身份证号码");
        } else {
            alert(idCardNo + "不是有效的身份证号码");
        }
    }
    ...
    function checkMobileNo() {
        ...
        //    alert(mobileNo + "是有效的手机号码");
        } else {
            alert(mobileNo + "不是有效的手机号码");
        }
    }
    ...
    function check() {
        var idCardNo = document.getElementById("idCardNo").value;
        var mobileNo = document.getElementById("mobileNo").value;
        if (isIdCardNo(idCardNo)&&isMobileNo(mobileNo)) {
        /*    alert("身份证号码或者手机号是有效的");*/
        } else {
            alert("身份证号码或者手机号不是有效的");
        }
    }
</script>
</body>
