  ...
  return (
    <div className={style.allPage}>
      <div className={style.topBox}>
        <Card size='small' title="权威医生" bordered={false} style={window.innerWidth < 700 ? { marginTop: '15px' } : { width: '49.5%' }}>
          <List
        ...
        <Card size='small' title="医院图片" bordered={false} style={window.innerWidth < 700 ? { marginTop: '15px' } : { width: '49.5%' }}>
