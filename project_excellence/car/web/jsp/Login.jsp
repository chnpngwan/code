			...
			<div id="deluheader_div">
				...
				<form id="form" action="LoginDao.do" method="post" >
						 <table>
							 ...
							 <tr>
								 <td colspan="2"><input id="input1" class="input" type="text" placeholder="+86>手机号/账号" name="username"/></td>
							 </tr>
							 <tr>
								 <td>&nbsp;</td>
							 </tr>
							 <tr>
							 	<td colspan="2"><input id="input2" class="input" type="password"  placeholder="密码" name="Userpassword"/><br />
