			...
			<div style="width: 100%;">
				<div class="carousel-inner" id="img_lunbo">
					<div class="item active">
						<img src="static/img/inb.jpg" style="height:400px;"/>
					</div>
				</div>
			</div>
			<!-- 搜索框 -->
			<div class="container-fluid" style="width: 0px auto;margin-top: 50px;">
				<div class="navbar-header grid" style="margin-top: 15px;">
					<ul class="grid nav-pills" style="margin-top: 5px;margin-left:180px;">
						...
						<li style="padding-top: 5px;">主页>车辆展示</li>
					</ul>
				</div>
		...
		<div style="width: 1180px;margin: 0px auto;margin-top: 150px;">
					...
					<div class="row clearfix grid grid-cell-3">
						...
						<c:forEach var="carList" items="${carList }">
							<div class="col-md-4 column" id="Button_Img">
								<img alt="140x140" src="${carList.img }" />
								<div class="row clearfix" id="Hover_price">
									...
									<div style="margin-left:100px;">
										<label>
											<strong style="font-size: 30px;margin-left:50px;">￥${carList.price }</strong>/天
										</label> 
									</div>
								</div>
							</div>
			...
			<div style="width: 1180px;margin: 0px auto;margin-top: 100px;" class="grid">
			       <div align="center" style="position: absolute;margin-top: 400px;">
						...
						<a href="<%=basePath %>/selectAllUser.do?page=1" style="color:blue;">首页</a>&emsp;
						<a href="<%=basePath %>/selectAllUser.do?page=${pageInfo.pageNum-1 }" style="color:blue;">上一页</a>&emsp;
						<c:forEach items="${pageInfo.navigatepageNums }" var="p">
						    <a href="<%=basePath %>/selectAllUser.do?page=${p }"  style="color:blue;">${p }</a>&nbsp;
						</c:forEach>
						<a href="<%=basePath %>/selectAllUser.do?page=${pageInfo.pageNum+1 }" style="color:blue;">下一页</a>&emsp;
						<a href="<%=basePath %>/selectAllUser.do?page=${pageInfo.pages }" style="color:blue;">尾页</a>&emsp;
		         </div>  
			</div>
		</header>
		<!-- 尾部 -->
