...
<script type="text/javascript" src="<%=path%>/static/echarts/js/jquery-3.1.1.min.js"></script>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function getData() {
            ...
            $.get("<%=path%>/stat/loadOpernameYearGradeStatJson.action",{year:year},function (data) {
