...
<br><br>
<h1 align="center"  style="color:LightSteelBlue ; font-size: 50px">汽车租赁系统</h1>
	<br><br>
	<form class="layui-form" id="loginFrm" method="post" action="<%=path%>/login/login.action">
		<div class="login_face"><img src="<%=path%>/static/images/face.jpg" class="userAvatar"></div>
		...
		<div class="layui-form-item input-item" id="imgCode">
			...
			<img src="<%=path%>/login/getCode.action" onclick="this.src=this.src+'?'">
		</div>
